...
export function SolutionSection() {
    ...
    return (
        <section id="solution" className="relative w-full bg-[#FF5532] py-20 md:py-[160px] px-0 md:px-12 flex flex-col items-center overflow-hidden">
            ...
            <motion.div
                ...
                className="w-full max-w-[1240px] px-6 flex flex-col gap-4 mb-12 md:mb-20 text-center md:text-left mx-auto"
            >
            ...
            <div className="w-full max-w-[1240px] grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-10">
                ...
                >
                    <DirectionAwareHover
                        imageUrl={isMobile ? "/assets/mobile_solution_precision_selective_harvesting_1.webp" : "/assets/SOLUTION_Precision Selective Harvesting.png"}
                        className="w-full h-[80vh] md:h-[500px] rounded-none md:rounded-3xl"
                ...
                >
                    <DirectionAwareHover
                        imageUrl={isMobile ? "/assets/mobile_sharp_rowcolumn_weed_cut_1.webp" : "/assets/Sharp RowColumn Weed Cut.png"}
                        className="w-full h-[80vh] md:h-[500px] rounded-none md:rounded-3xl mt-2 md:mt-0"
                        imageClassName="object-cover"
                    >
                        <div className="p-4 flex flex-col gap-3">
                            <h3
